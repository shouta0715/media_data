...
# JSONファイルのパスを指定
file_path = "./final_result_cleaned_v2.json"
...
# 結果をJSONファイルに保存
with open("final_result_cleaned_v3.json", "w", encoding="utf-8") as file:
    json.dump(final_result, file, ensure_ascii=False, indent=2)

print("処理が完了しました。結果はfinal_result_cleaned_v3.jsonファイルに保存されています。")
